...
import { TermsAndServicesTwoData } from '../types';

export type TermsAndServicesTwoProps = {
  data: TermsAndServicesTwoData;
};

export default function TermsAndServicesTwo({ data }: TermsAndServicesTwoProps) {
