...
export default function ImpactFactory({ name, data }: Props) {
  switch (name) {
    case ImpactComponentName.IMPACT_ONE:
      return <ImpactOne data={data} />;

    case ImpactComponentName.IMPACT_TWO:
      return <ImpactTwo data={data} />;

    case ImpactComponentName.IMPACT_THREE:
      return <ImpactThree data={data} />;

    case ImpactComponentName.IMPACT_FOUR:
      return <ImpactFour data={data} />;
