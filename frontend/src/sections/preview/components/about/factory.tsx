...
export default function AboutFactory({ name, data, ...rest }: Props) {
  switch (name) {
    case AboutComponentName.ABOUT_ONE:
      return <AboutOne data={data} {...rest} />;

    case AboutComponentName.ABOUT_TWO:
      return <AboutTwo data={data} {...rest} />;

    case AboutComponentName.ABOUT_THREE:
      return <AboutThree data={data} {...rest} />;

    case AboutComponentName.ABOUT_FOUR:
      return <AboutFour data={data} {...rest} />;

    case AboutComponentName.ABOUT_FIVE:
      return <AboutFive data={data} {...rest} />;

    case AboutComponentName.ABOUT_SIX:
      return <AboutSix data={data} {...rest} />;

    case AboutComponentName.ABOUT_SEVEN:
      return <AboutSeven data={data} {...rest} />;
