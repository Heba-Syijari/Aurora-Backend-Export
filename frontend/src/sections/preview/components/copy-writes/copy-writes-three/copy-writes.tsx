...
import { CopyWriteThreeData } from '../types';
...
export type CopyWriteThreeProps = {
  data: CopyWriteThreeData;
  editMode?: boolean;
};

export default function CopyWriteThree({ data }: CopyWriteThreeProps) {
