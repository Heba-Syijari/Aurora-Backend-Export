...
export default function OurSoulutionsFactory({ name, data, ...rest }: Props) {
  switch (name) {
    case OurSolutionComponentName.OUR_SOLUTION_ONE:
      return <OurSolutionOne data={data} {...rest} />;

    case OurSolutionComponentName.OUR_SOLUTION_TWO:
      return <OurSolutionTwo data={data} {...rest} />;

    case OurSolutionComponentName.OUR_SOLUTION_THREE:
      return <OurSolutionThree data={data} {...rest} />;

    case OurSolutionComponentName.OUR_SOLUTION_FOUR:
      return <OurSolutionFour data={data} {...rest} />;
