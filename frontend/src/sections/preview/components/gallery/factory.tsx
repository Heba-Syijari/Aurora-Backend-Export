...
export default function GalleryFactory({ name, data, ...rest }: Props) {
  switch (name) {
    case GalleryComponentName.GALLERY_ONE:
      return <GalleryOne data={data} {...rest} />;
    case GalleryComponentName.GALLERY_TWO:
      return <GalleryTwo data={data} {...rest} />;
    case GalleryComponentName.GALLERY_THREE:
      return <GalleryThree data={data} {...rest} />;
    case GalleryComponentName.GALLERY_FOUR:
      return <GalleryFour data={data} {...rest} />;
    case GalleryComponentName.GALLERY_FIVE:
      return <GalleryFive data={data} {...rest} />;
    case GalleryComponentName.GALLERY_SIX:
      return <GallerySix data={data} {...rest} />;
    case GalleryComponentName.GALLERY_SEVEN:
      return <GallerySeven data={data} {...rest} />;
    default:
      return null;
  }
}
